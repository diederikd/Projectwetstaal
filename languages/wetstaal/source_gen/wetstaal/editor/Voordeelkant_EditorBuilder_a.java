...
/*package*/ class Voordeelkant_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Voordeelkant_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_z6ziza_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_z6ziza_a0");
  ...
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_z6ziza_b0");
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createProperty_0());
    return editorCell;
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Binair feittype");
    editorCell.setCellId("Constant_z6ziza_a1a");
    Style style = new StyleImpl();
  ...
  private EditorCell createCollection_3() {
    ...
    editorCell.setCellId("Collection_z6ziza_c0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_z6ziza_a2a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_z6ziza_b2a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.rechtsbetrekking$4ksT;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.rechtsbetrekking$4ksT);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.rechtsbetrekking$4ksT);
    }
  ...
  private EditorCell createCollection_4() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_z6ziza_d0");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new rollenListHandler_z6ziza_b3a(myNode, getEditorContext());
  ...
  private static class rollenListHandler_z6ziza_b3a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public rollenListHandler_z6ziza_b3a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(rollenListHandler_z6ziza_b3a.this.getNode(), LINKS.rollen$hqtc));
      try {
  ...
  private EditorCell createCollection_5() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_z6ziza_e0");
    Style style = new StyleImpl();
    new NatuurlijkeTaalStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createTooltip_0(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "wetstaal.editor.GeneratedHints.tooltipHint_z6ziza_c4a", true);
    ...
    editorCell.setCellId("Tooltip_z6ziza_c4a");
    return editorCell;
  }
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new Voordeelkant_generic_cellMenu_z6ziza_a0a2e0(), new Voordeelkant_generic_cellMenu_z6ziza_b0a2e0(), new SChildSubstituteInfoPartEx(editorCell)}));
    editorCell.setCellId("ReadOnlyModelAccessor_z6ziza_a2e0");
    Style style = new StyleImpl();
  ...
  public static class Voordeelkant_generic_cellMenu_z6ziza_a0a2e0 extends AbstractCellMenuPart_Generic_Item {
    public Voordeelkant_generic_cellMenu_z6ziza_a0a2e0() {
    }
    @Override
        ...
        public SubstituteAction apply(SubstituteAction action) {
          return new NodeSubstituteActionWrapper(action) {
            ...
            public EditorMenuTraceInfo getEditorMenuTraceInfo() {
              ...
              result.setDescriptor(new EditorMenuDescriptorBase("generic item", new SNodePointer("r:b40bf9b3-297f-4eb4-aaeb-f4d0f653226e(wetstaal.editor)", "1731147829587264054")));
              return result;
            }
          };
        }
  ...
  public static class Voordeelkant_generic_cellMenu_z6ziza_b0a2e0 extends AbstractCellMenuPart_Generic_Item {
    public Voordeelkant_generic_cellMenu_z6ziza_b0a2e0() {
    }
    @Override
    public List<SubstituteAction> createActions(CellContext cellContext, EditorContext editorContext) {
      List<SubstituteAction> actions = super.createActions(cellContext, editorContext);
      Function<SubstituteAction, SubstituteAction> mapper = new Function<SubstituteAction, SubstituteAction>() {
        public SubstituteAction apply(SubstituteAction action) {
          return new NodeSubstituteActionWrapper(action) {
            ...
            public EditorMenuTraceInfo getEditorMenuTraceInfo() {
              EditorMenuTraceInfoImpl result = new EditorMenuTraceInfoImpl();
              result.setDescriptor(new EditorMenuDescriptorBase("generic item", new SNodePointer("r:b40bf9b3-297f-4eb4-aaeb-f4d0f653226e(wetstaal.editor)", "1731147829587264067")));
              return result;
            }
          };
        }
  ...
  private EditorCell createReadOnlyModelAccessor_1() {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_z6ziza_d4a");
    Style style = new StyleImpl();
  ...
  private EditorCell createTooltip_2(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "wetstaal.editor.GeneratedHints.tooltipHint_z6ziza_e4a", true);
    EditorCell visibleCell = createModelAccess_0();

    TooltipWrapper editorCell = new TooltipWrapper(editorContext, node, visibleCell, tooltip, TooltipTimingProperties.DEFAULT);
    editorCell.setCellId("Tooltip_z6ziza_e4a");
    return editorCell;
  }
  ...
  private EditorCell createModelAccess_0() {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ModelAccess_z6ziza_a4e0");
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new Voordeelkant_generic_cellMenu_z6ziza_a0a4e0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  public static class Voordeelkant_generic_cellMenu_z6ziza_a0a4e0 extends AbstractCellMenuPart_Generic_Group {
    public Voordeelkant_generic_cellMenu_z6ziza_a0a4e0() {
    }
    ...
    protected EditorMenuDescriptor getEditorMenuDescriptor(Object parameterObject) {
      return new EditorMenuDescriptorBase("generic group with parameter: " + ((parameterObject == null ? "null" : parameterObject.toString())), new SNodePointer("r:b40bf9b3-297f-4eb4-aaeb-f4d0f653226e(wetstaal.editor)", "1731147829587264123"));
    }
  }
  private EditorCell createTooltip_4(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "wetstaal.editor.GeneratedHints.tooltipHint_z6ziza_f4a", true);
    EditorCell visibleCell = createReadOnlyModelAccessor_2();

    TooltipWrapper editorCell = new TooltipWrapper(editorContext, node, visibleCell, tooltip, TooltipTimingProperties.DEFAULT);
    editorCell.setCellId("Tooltip_z6ziza_f4a");
    return editorCell;
  }
  ...
  private EditorCell createReadOnlyModelAccessor_2() {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new Voordeelkant_generic_cellMenu_z6ziza_a0a5e0(), new Voordeelkant_generic_cellMenu_z6ziza_b0a5e0(), new SChildSubstituteInfoPartEx(editorCell)}));
    editorCell.setCellId("ReadOnlyModelAccessor_z6ziza_a5e0");
    Style style = new StyleImpl();
    new NaamReferentieStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.EDITABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  public static class Voordeelkant_generic_cellMenu_z6ziza_a0a5e0 extends AbstractCellMenuPart_Generic_Item {
    public Voordeelkant_generic_cellMenu_z6ziza_a0a5e0() {
    }
    @Override
    public List<SubstituteAction> createActions(CellContext cellContext, EditorContext editorContext) {
      List<SubstituteAction> actions = super.createActions(cellContext, editorContext);
      Function<SubstituteAction, SubstituteAction> mapper = new Function<SubstituteAction, SubstituteAction>() {
        public SubstituteAction apply(SubstituteAction action) {
          return new NodeSubstituteActionWrapper(action) {
            ...
            public EditorMenuTraceInfo getEditorMenuTraceInfo() {
              EditorMenuTraceInfoImpl result = new EditorMenuTraceInfoImpl();
              result.setDescriptor(new EditorMenuDescriptorBase("generic item", new SNodePointer("r:b40bf9b3-297f-4eb4-aaeb-f4d0f653226e(wetstaal.editor)", "1731147829587264188")));
              return result;
            }
          };
        }
  ...
  public static class Voordeelkant_generic_cellMenu_z6ziza_b0a5e0 extends AbstractCellMenuPart_Generic_Item {
    public Voordeelkant_generic_cellMenu_z6ziza_b0a5e0() {
    }
    @Override
    public List<SubstituteAction> createActions(CellContext cellContext, EditorContext editorContext) {
      List<SubstituteAction> actions = super.createActions(cellContext, editorContext);
      Function<SubstituteAction, SubstituteAction> mapper = new Function<SubstituteAction, SubstituteAction>() {
        public SubstituteAction apply(SubstituteAction action) {
          return new NodeSubstituteActionWrapper(action) {
            ...
            public EditorMenuTraceInfo getEditorMenuTraceInfo() {
              EditorMenuTraceInfoImpl result = new EditorMenuTraceInfoImpl();
              result.setDescriptor(new EditorMenuDescriptorBase("generic item", new SNodePointer("r:b40bf9b3-297f-4eb4-aaeb-f4d0f653226e(wetstaal.editor)", "1731147829587264201")));
              return result;
            }
          };
        }
  ...
  private EditorCell createReadOnlyModelAccessor_3() {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_z6ziza_g4a");
    Style style = new StyleImpl();
    new RolStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.EDITABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_z6ziza_f0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_z6ziza_g0");
    Style style = new StyleImpl();
